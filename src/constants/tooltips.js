...
export const tooltips = {
  sweetness: `Sweetness is how much sugar you taste in the wine.
...
There are also in-between levels, like semi-sweet.`,
  ...
  acidity: `Acidity is what makes the wine feel fresh, lively, or zesty.
...
A wine with less acidity is more smooth or flat.`,
  ...
  tannin: `Tannins are what make the wine feel dry or rough in your mouth.
...
It’s like drinking strong black tea or eating a green banana — it dries your mouth.`,
  ...
  body: `The body of the wine is how it feels in your mouth.
...
It depends on the alcohol, sugars, and other elements in the wine.`,
  ...
  persistence: `Persistence is how long the flavor of the wine stays in your mouth after you swallow.
